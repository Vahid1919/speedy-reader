...
export default function Home() {
  ...
  return (
    <div>
      <Nav></Nav>
      <Main stringArray={stringArray} wpm={wpm}></Main>
      <Controls wpm={wpm} setWpm={updateWpm}></Controls>
    </div>
  )
}
